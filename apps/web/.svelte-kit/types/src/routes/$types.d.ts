...
type LayoutRouteId = RouteId | "/" | "/(app)/calendars/[calendarId]" | "/(app)/calendars/[calendarId]/find-time" | "/(app)/groups" | "/(auth)/signin" | null
type LayoutParams = RouteParams & { calendarId?: string }
