...
import { M as MobileShell, p as primaryCalendarLandingHref } from "../../../chunks/load-app-shell.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    MobileShell($$renderer2, {
      ...
      children: ($$renderer3) => {
        $$renderer3.push(`<section class="hero-stack svelte-1sgss7h" data-testid="groups-shell"${attr("data-shell-bootstrap", shellBootstrapMode)}${attr("data-onboarding-state", appShell()?.onboardingState ?? "unknown")}><article class="hero-card framed-panel svelte-1sgss7h"><div><p class="panel-kicker svelte-1sgss7h">Pocket overview</p> <h2 class="svelte-1sgss7h">${escape_html(appShell()?.primaryCalendar ? "Your first tap can be the right calendar." : "Protected scope is still settling.")}</h2></div> <p class="panel-copy svelte-1sgss7h">`);
        if (hasError()) {
          $$renderer3.push("<!--[1-->");
        ...
        if (appShell()?.primaryCalendar) {
          ...
          $$renderer3.push("<!--[-1-->");
          $$renderer3.push(`<a class="button button-primary svelte-1sgss7h" href="/signin">Stay on sign-in</a>`);
        }
        $$renderer3.push(`<!--]--> <a class="button button-secondary svelte-1sgss7h" href="/signin">Account state</a></div></article> `);
        if (appShell()?.onboardingState === "needs-group") {
          $$renderer3.push("<!--[1-->");
