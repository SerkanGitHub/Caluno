...
function MobileShell($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="mobile-shell-frame svelte-kxq9s8"${attr("data-testid", shellTestId ?? "mobile-shell-frame")}${attr("data-shell-bootstrap", shellBootstrapMode)}${attr("data-route-mode", routeMode)}${attr("data-snapshot-origin", snapshotOrigin)}${attr("data-continuity-reason", continuityReason ?? "none")}${attr("data-last-trusted-refresh-at", lastTrustedRefreshAt ?? "none")}${attr("data-onboarding-state", onboardingState ?? "unknown")}><header class="mobile-shell-header framed-panel svelte-kxq9s8"><div class="shell-kicker-row svelte-kxq9s8"><p class="eyebrow svelte-kxq9s8">Caluno pocket shell</p> <div class="shell-header-actions svelte-kxq9s8"><span class="viewer-chip svelte-kxq9s8">${escape_html(viewerName)}</span> <button class="signout-chip svelte-kxq9s8" type="button"${attr("disabled", signingOut, true)} data-testid="mobile-shell-signout">${escape_html("Sign out")}</button></div></div> <div class="mobile-shell-copy svelte-kxq9s8"><h1 class="svelte-kxq9s8">${escape_html(title)}</h1> <p class="svelte-kxq9s8">${escape_html(subtitle)}</p></div> <div class="status-ribbon svelte-kxq9s8"><article${attr_class(`status-pill ${shellTone()}`, "svelte-kxq9s8")} data-testid="mobile-shell-status"><span class="svelte-kxq9s8">Shell state</span> <strong class="svelte-kxq9s8">${escape_html(shellLabel())}</strong></article> <article${attr_class(
