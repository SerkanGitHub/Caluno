...
- Validation: unmapped
- Notes: Deferred from M004. M004 was rescoped to test-hygiene close-out only. Predictive scheduling assistance will be the primary goal of a future milestone once launch hardening and product foundations are ready.
...
| R011 | differentiator | deferred | M004 (provisional) | none | unmapped |
