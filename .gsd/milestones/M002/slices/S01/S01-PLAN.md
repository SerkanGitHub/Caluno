...
- [x] **T02: Build the 30-day availability matcher and protected server route contract** `est:2h`
...
- [x] **T03: Ship the browseable `/find-time` UI, calendar entrypoint, and offline fail-closed browser proof** `est:2h`
