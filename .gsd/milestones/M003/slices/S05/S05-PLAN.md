# S05: Cross-surface notification correctness and final mobile assembly proof
...
- [x] **T01: Wire best-effort shared-change dispatch into trusted web schedule mutations** `est:90m`
...
- [ ] **T02: Wire shared-change dispatch into mobile direct writes and reconnect drain** `est:90m`
...
- [ ] **T03: Extend the Playwright notification harness to prove enabled delivery, quiet disabled calendars, and duplicate suppression** `est:2h`
...
- [ ] **T04: Add the final assembled mobile tracer bullet and promote it into the default E2E bar** `est:90m`
