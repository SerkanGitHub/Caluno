...
- `apps/mobile/.svelte-kit/output/client/_app/immutable/assets/load-app-shell.RtvhMW7e.css`
...
- `apps/mobile/.svelte-kit/output/server/_app/immutable/assets/load-app-shell.C33lfloN.css`
